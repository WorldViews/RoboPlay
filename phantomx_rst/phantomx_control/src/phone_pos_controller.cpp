...
void phonepos_Callback(const geometry_msgs::Vector3& vel)
{
  Hand_Pos[0] = vel.x;
  Hand_Pos[1] = vel.y;
  Hand_Pos[2] = vel.z;
  ROS_INFO("I heard phone_pos");
}
...
int main(int argc, char **argv)
{
  ...
  ros::NodeHandle x_nh,y_nh,z_nh,roll_nh,pitch_nh,yaw_nh,kinect_nh,phone_nh;
  ...
  ros::Subscriber phone_sub = phone_nh.subscribe("/phone_pos",1000,phonepos_Callback);
